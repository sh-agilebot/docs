---
url: /zh/02-development/03-advanced/01-complex-page.md
---
# 复杂的Web小程序
...
在此处的示范中，我们将创建一个Web小程序类型的插件。该插件的功能是调用入门教程中的[MathService](../02-quick-start/02-easy-service)，并返回加法计算的结果显示在页面中。
...
![](/images/development/创建vite项目.png)
