---
url: /zh/02-development/03-advanced/03-complex-backend.md
---
# 简单服务中调用SDK
...
:::warning 警告
工业插件不含此指令，请使用接口方式调用，[参考文档](../02-quick-start/02-easy-service#call-interface)
:::

1. 选择插入指令`CALL_SERVICE`

![](/images/development/CallService1.png)

2. 填写`CALL_SERVICE`指令的相关参数

![](/images/development/CallService2.png)
...
![](/images/development/CallService3.png)

4. 用户程序执行成功后，将在`R[1]`中写入值`3`

![](/images/development/CallService4.png)
