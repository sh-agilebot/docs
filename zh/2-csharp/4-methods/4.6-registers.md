...
public class Test
{
    public static async Task Main()
    {
        ...
        // 寄存器操作
        code = controller.Registers.Write_R(index, 9.9);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully write.");
        (double value, code) = controller.Registers.Read_R(index);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : $"Value: {value}");
        code = controller.Registers.Delete_R(index);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully delete.");
...
public class Test
{
    public static async Task Main()
    {
        ...
        // 寄存器操作
        code = controller.Registers.Write_MR(index, 9);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully write.");
        (double value, code) = controller.Registers.Read_MR(index);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : $"Value: {value}");
...
public class Test
{
    public static async Task Main()
    {
        ...
        // 寄存器操作
        code = controller.Registers.Write_SR(index, "test");
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully write.");
...
public class Test
{
    public static async Task Main()
    {
        ...
        PoseRegister pose = PoseRegister.GenerateRandomPoseRegister(index);

        // 寄存器操作
        code = controller.Registers.Write_PR(pose);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully write.");
        (PoseRegister value, code) = controller.Registers.Read_PR(index);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : $"ID: {value.Id}");
...
public class Test
{
    public static async Task Main()
    {
        ...
        if (code == StatusCode.OK)
        {
            Console.WriteLine($"MH: {value1}");
            Console.WriteLine($"MI: {value2}");
        }
