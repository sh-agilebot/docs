...
public class Test
{
    public static async Task Main()
    {
        ...
        // Act
        (MotionPose convertPose, code) = controller.Motion.ConvertCartToJoint(motionPose);
        if (code == StatusCode.OK)
        {
...
public class Test
{
    public static async Task Main()
    {
        ...
        // Act
        (MotionPose convertPose, code) = controller.Motion.ConvertJointToCart(motionPose);
...
public class Test
{
    public static async Task Main()
    {
        ...
        // Act
        code = controller.Motion.MoveJoint(motionPose);
        if (code == StatusCode.OK)
        {
...
public class Test
{
    public static async Task Main()
    {
        ...
        // Act
        code = controller.Motion.MoveLine(motionPose);
        if (code == StatusCode.OK)
        {
            Console.WriteLine("Request Success");
        }
...
public class Test
{
    public static async Task Main()
    {
        ...
        // 获取机器人软限位
        (List<List<double>> res, StatusCode code2) = controller.Motion.GetUserSoftLimit();
        if (code2 == StatusCode.OK)
        {
...
public class Test
{
    public static async Task Main()
    {
        ...
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully set.");
...
public class Test
{
    public static async Task Main()
    {
        ...
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully get payload list.");
        ...
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully add payload.");

        // 设置当前激活的负载
        code = controller.Motion.Payload.SetCurrentPayload(3);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully set payload.");
...
public class Test
{
    public static async Task Main()
    {
        ...
        // 执行负载测定
        (PayloadInfo payload, code) = controller.Motion.Payload.PayloadIdentify(-1, 90);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully Identify.");

        payload.Id = 6;

        // 保存负载到机器人中
        code = controller.Motion.Payload.AddPayload(payload);
        Console.WriteLine(code != StatusCode.OK ? code.GetDescription() : "Successfully add.");
